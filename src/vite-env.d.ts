...
declare const __BACKEND_Admin_URL__: string;
declare const __AttendanceRecord_TableName: string;
declare const __Workers_TableName: string;
declare const __WorkTypes_TableName: string;
