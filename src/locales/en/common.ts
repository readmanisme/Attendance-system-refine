const en = {
  ...
  documentTitle: {
    default: "Classroom Behavior Detection System",
    suffix: " | Classroom Behavior Detection System",
    post: {
      list: "Posts | Classroom Behavior Detection System",
      show: "#{{id}} Show Post | Classroom Behavior Detection System",
      edit: "#{{id}} Edit Post | Classroom Behavior Detection System",
      create: "Create new Post | Classroom Behavior Detection System",
      clone: "#{{id}} Clone Post | Classroom Behavior Detection System",
    },
  },
  autoSave: {
    success: "saved",
